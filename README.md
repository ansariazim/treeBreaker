...
TreeBreaker can be installed and used as a standalone application as described below. Alternatively, TreeBreaker can also be used as a R package, as described [here](https://rawgit.com/ansariazim/treeBreaker/master/vignettes/intro.html).
